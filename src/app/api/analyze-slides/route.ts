      ...
      pages.map(async (page, index) => {
        ...
        const analysis = await openai.chat.completions.create({
          ...
          messages: [
            {
              role: "system",
              content: "You are an expert at analyzing lecture slides. Generate a concise summary of the slide content. Focus on key points and main ideas."
            },
            {
              role: "user",
              content: `Analyze this slide content and provide a concise summary:\n\n${content}`
            }
          ],
          temperature: 0.3,
